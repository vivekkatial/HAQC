...
do
   ...
   log_file="logs/qaoa_maxcut_initialisation_techniques_run_all_instance_$i.log"
   echo "Results will be logged into $log_file"
   sbatch --mem $NodeMemory --output=$log_file bin/maxcut/qaoa_initial_methods/run_maxcut.slurm
