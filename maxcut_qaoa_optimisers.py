...
def main(track_mlflow=False):
    ...
    N = instance_size
    print(
        f"Running job on instance size of N={instance_size} for various classical optimizers"
    )
    OPTIMIZERS = [
                ...
                if track_mlflow:
                    ...
                    with make_temp_directory() as temp_dir:
                        ...
                        try:
                            ...
                            pylab.ylabel("Energy")
                            pylab.title(
                                f"Energy convergence for {instance_type_logging} -- p = {N_LAYERS}, optimizer: {optimizer.label}"
                            )
                            pylab.legend(loc="upper right")
